     ...
     <center><h1 style={{ fontSize: "3rem"}}>  PROJECTS</h1>
      ...
      <img src={Macicon} className="macicon"alt="Avatar" width="480px" height="460px" />
              ...
              <div className="flip-card-back">
                ...
                <p>
                  Built with React and SemanticUI this project was done using React and the SemanticUI framework.
                  To pull the data from the Rick and Morty API I implemented an asynchronous api call using the axios library.
                </p>
                <br /> <br />
                <a href="https://github.com/ron-hughes/Sprint-Challenge-Single-Page-Apps"> <h3>Github Repo</h3></a>
                    DEMO PAGE<br />
                  <a href="https://rickandmorty.ronhughes.dev">https://rickandmorty.ronhughes.dev</a>
...
<img src={Bookricon} className="bookr" width="390px" height="235px"/>
    ...
    <div className="flip-card-back">
      ...
      <a href="https://github.com/ron-hughes/Sprint-Challenge-Single-Page-Apps"> <h3>Github Repo</h3></a>
                    DEMO PAGE<br />
                  <a href="https://bookr.ronhughes.dev">https://bookr.ronhughes.dev</a>
    </div>
  </div> 
</div> 
</div>
